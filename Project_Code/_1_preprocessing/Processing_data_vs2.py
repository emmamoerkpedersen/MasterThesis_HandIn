...
from data_utils.data_loading import load_all_station_data, save_preprocessed_data
...
def preprocess_data():
    ...
    save_preprocessed_data(All_station_data)
...
#data = pd.read_pickle('data/processed/preprocessed_data.pkl')
