...
ALTERNATING_CONFIG = {
    ...
    'use_lagged_features': True,     # RE-ENABLED: Add lagged water level features for better peak/valley prediction
    ...
    'anomaly_detection_window': 1500,   # Window size for MAD calculation
